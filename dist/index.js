...
*/
export function usePager(pager, queue, pageSize = 50, process = (item, offset) => item) {
    const maxRequested = useRef(0);
     ...
     */
    function insertTracks(newTracks, offset) {
        setProcessed(tracks => {
     ...
     */
    async function loadMorePages(calculateLimit) {
